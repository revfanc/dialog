...
// 工具函数
const preventDefault = (event: TouchEvent, isStopPropagation: boolean): void => {
...
const getScrollParent = (el: HTMLElement, root: Window | HTMLElement = window): HTMLElement | Window => {
